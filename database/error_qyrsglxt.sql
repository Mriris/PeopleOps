...
CREATE TABLE `bm` (
  ...
  `cz` varchar(20) COLLATE utf8 DEFAULT NULL COMMENT '传真',
...
CREATE TABLE `gw` (
  `id` char(32) COLLATE utf8 NOT NULL DEFAULT '' COMMENT 'id',
  `bh` char(5) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '编号',
  `mc` varchar(20) COLLATE utf8 DEFAULT NULL COMMENT '名称',
  `lx` char(1) COLLATE utf8 DEFAULT NULL COMMENT '类型，分为：1经理、2主管、3专员',
  PRIMARY KEY (`id`)
...
CREATE TABLE `lz` (
  `id` char(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT 'id',
  `ygid` char(32) COLLATE utf8 NOT NULL DEFAULT '' COMMENT '员工id',
  `lzrq` char(10) COLLATE utf8 DEFAULT NULL COMMENT '离职日期，格式2024-05-01',
...
CREATE TABLE `sy` (
  ...
  `jsrq` char(10) COLLATE utf8 DEFAULT NULL COMMENT '试用期结束日期，格式2024-04-01',
  PRIMARY KEY (`id`)
...
CREATE TABLE `yg` (
  ...
  `bmid` char(32) COLLATE utf8 NOT NULL DEFAULT '' COMMENT '部门id',
