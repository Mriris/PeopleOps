...
CREATE TABLE `bm` (
  ...
  `bh` char(4) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '编号',
  `mc` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '名称',
  `dh` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '电话',
  `cz` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '传真',
  `clrq` char(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '成立日期，格式2020-01-01',
  PRIMARY KEY (`id`)
...
CREATE TABLE `gly` (
  `id` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'id',
  `zhm` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '账户名',
  `mm` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '密码',
  `nc` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '昵称',
  PRIMARY KEY (`id`)
...
CREATE TABLE `gw` (
  `id` char(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'id',
  `bh` char(5) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '编号',
  `mc` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '名称',
  `lx` char(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型，分为：1经理、2主管、3专员',
  PRIMARY KEY (`id`)
...
CREATE TABLE `lz` (
  `id` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'id',
  `ygid` char(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '员工id',
  `lzrq` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '离职日期，格式2024-05-01',
  `lzlx` char(1) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '离职类型：1主动辞职、2辞退、3退休、4开除、5试用期未通过',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='员工离职信息表';
...
CREATE TABLE `sy` (
  `id` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'id',
  `ygid` char(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '员工id',
  `zt` char(1) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '试用期状态：1正常、2结束、3延期、4不录用',
  `ksrq` char(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '试用期开始日期，格式2024-01-01',
  `jsrq` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '试用期结束日期，格式2024-04-01',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='员工试用信息表';
...
CREATE TABLE `yg` (
  `id` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'id',
  `bh` char(6) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '编号',
  `xm` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '姓名',
  `xb` char(1) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '性别：1男、2女',
  `csrq` char(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '出生日期，格式2000-01-01',
  `bmid` char(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '部门id',
  `gwid` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '岗位id',
  `rzrq` char(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '入职日期，格式2021-01-01',
  `zzzt` char(1) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '在职状态：1在职、2试用、3离职',
  PRIMARY KEY (`id`)
